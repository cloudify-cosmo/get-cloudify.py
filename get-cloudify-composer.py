...
COMPOSER_STABLE_SOURCE = 'http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/{0}/ga-RELEASE/cloudify-blueprint-composer-{0}-ga-b{1}.tgz'.format('3.4.0', '400')  # NOQA
